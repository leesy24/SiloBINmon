...
'
    If (frmF.WindowState <> vbMinimized) And (App.Title <> "") Then
        SaveSetting App.Title, "FormsPositions", frmF.Name & "_Left", frmF.Left
        SaveSetting App.Title, "FormsPositions", frmF.Name & "_Top", frmF.Top
'
        If Dimensioni Then
            SaveSetting App.Title, "FormsPositions", frmF.Name & "_Width", frmF.Width
            SaveSetting App.Title, "FormsPositions", frmF.Name & "_Height", frmF.Height
        End If
    End If
'
'
...
'
    If App.Title <> "" Then
        frmF_Left = Val(GetSetting(App.Title, "FormsPositions", frmF.Name & "_Left", 0))
        frmF_Top = Val(GetSetting(App.Title, "FormsPositions", frmF.Name & "_Top", 0))
'
        frmF_Width = Val(GetSetting(App.Title, "FormsPositions", frmF.Name & "_Width", Screen.Width))
        frmF_Height = Val(GetSetting(App.Title, "FormsPositions", frmF.Name & "_Height", Screen.Height))
    Else
        frmF_Left = 0
        frmF_Top = 0
'
